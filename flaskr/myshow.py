...
def get_my_show(show_id):
    """
    Create an object myshow of the ShowDetailedView class with all the information about our myshow.
    :return: the myshow.html template with all the information about the myshow contained in the object myshow
    """
